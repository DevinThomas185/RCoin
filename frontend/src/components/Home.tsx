  ...
  return (
    <ChakraProvider theme={theme}>
      <Box textAlign="center" fontSize="xl">
        <Grid minH="100vh" p={3}>
          <IssuePage pageName={"Issue"} title={"From ZAR to our coin, RCoin"} colour={'red'} link={"issue"}
          ...
          <TradePage pageName={"Trade"} title={"Trade RCoin with others"} colour={'blue'} link={"issue"}
          ...
          <IssuePage pageName={"Redeem"} title={"From RCoin back to ZAR"} colour={'green'} link={"redeem"}
