      ...
      <Box bg={useColorModeValue('#A5315B', '#611f37')} px={4}>
        ...
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <HStack spacing={8} alignItems={'center'}>
            <Link to='/'>
              <Icon viewBox="0 0 316.52 414.1" color='white'>
                {/* <path
                  fill='currentColor'
